      ...
      <div className="mb-8">
        ...
        <div className="mt-8">
          ...
          <div className="flex items-center justify-between space-x-2">
            <Button
              classNames={[
                "flex-1 bg-orange-500 text-white py-3 rounded-md cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500 font-medium hover:bg-orange-600",
              ]}
            >
              Talk to seller
            </Button>
            <Button
              classNames={[
                "p-3 flex items-center justify-center text-gray-400 hover:bg-gray-100 hover:text-gray-500 rounded-md",
              ]}
            >
              <svg
                className="h-6 w-6 "
